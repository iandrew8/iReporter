...
public interface IncidentService {
	...
	/**
	 * Saves an {@link Incident}.An incident must have an id, title, type, status and comment.In case any of (id, title, type, createdOn, comment and status) contains a null value, a {@link ValidationFailedException} must be thrown
 The title, and comment must not be empty.In case a Incident fails to save after all validation criteria is met. Throw {@link SavingFailedException}
	 * 
     * @param incident
	 * @throws Exception
	 */
